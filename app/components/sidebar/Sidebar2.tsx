...
const SidebarMenu = ({ mobileMenuOpen, setMobileMenuOpen }:any) => {
  const menus = [
    ...
    {
      name: "Bus Booking",
      link: "/dashboard/bus-services/route",
      icon: FaBusAlt,
      subMenu: [
              ...
              <div className=" flex flex-col gap-4  ">
                {menus?.map((menu:any, i) => (
                  <Link
                    ...
                    title={menu.name}
                    className={
                      `${menu?.margin ? "mt-5" : ""}  group flex items-center text-sm gap-2 font-medium p-2 hover:bg-gray-200 rounded-md`
                    }
                  >
                ...
                <nav className="px-4 space-y-1">
                  {menus.map((menu:any, i) => (
                    <Link
                      ...
                      key={i}
                      className={
                        `${menu?.margin ? "mt-5" : ""}group flex items-center text-sm gap-2  font-medium p-2 hover:bg-gray-100 rounded-md transform hover:scale-105 hover:translate-x-2 transition-transform duration-300`
                      }
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      <div>
